            ...
            if (args.length > 0) {
                ...
                if (args[0].equalsIgnoreCase("add") || args[0].equalsIgnoreCase("give")) {
                    if (args.length > 1) {
                        ...
                        player.addBits(Integer.parseInt(args[1]));
                    ...
                    sender.sendMessage(ChatColor.GREEN + player.getName() + " has " + ChatColor.AQUA + player.bits + ChatColor.GREEN + ".");
                    ...
                    if (args.length > 1) {
                        ...
                        player.setBits(Integer.parseInt(args[1]));
