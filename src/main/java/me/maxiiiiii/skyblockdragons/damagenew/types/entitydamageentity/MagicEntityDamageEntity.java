...
public class MagicEntityDamageEntity extends EntityDamageEntity {
    ...
    public MagicEntityDamageEntity(EntitySD attacker, EntitySD victim, Equipment equipment, boolean isFerocity, ItemAbility ability) {
        super(attacker, victim, equipment, isFerocity);
        this.ability = ability;
    }

    public MagicEntityDamageEntity(EntitySD attacker, EntitySD victim, Equipment equipment, ItemAbility ability) {
