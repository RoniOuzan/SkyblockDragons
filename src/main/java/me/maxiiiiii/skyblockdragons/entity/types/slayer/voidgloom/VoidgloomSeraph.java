...
public abstract class VoidgloomSeraph extends SlayerBoss {
    public VoidgloomSeraph(int level, double health, double defense, double damage, double trueDamage, Equipment equipment, double speed, double knockbackResistance, double combatXp, double coins, int tier, EntityDrop... drops) {
        super(EntityType.ENDERMAN,
                ChatColor.DARK_RED + "Voidgloom Seraph",
                level,
                health,
                defense,
                damage,
