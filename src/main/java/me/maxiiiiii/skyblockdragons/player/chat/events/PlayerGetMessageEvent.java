...
@Getter
@Setter
public class PlayerGetMessageEvent extends PlayerSDEvent implements Cancellable {
    ...
    public PlayerGetMessageEvent(PlayerSD player, String message, ChatChannel channel) {
        super(player);
