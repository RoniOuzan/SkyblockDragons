...
public abstract class MiningBlockMaterial extends BlockMaterial {
    public MiningBlockMaterial(String itemID, BlockMaterials material, double blockStrength, int breakingPower, double skillExp, int experience, BlockDrop... drops) {
