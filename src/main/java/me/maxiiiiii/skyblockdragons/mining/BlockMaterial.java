...
public enum BlockMaterial {
    ...
    LAPIS_ORE(25, 2, 3, 6, new Drop(Items.get("LAPIS"), 4, 6)),
    REDSTONE_ORE(25, 3, 1.5, 3, new Drop(Items.get("REDSTONE"), 2, 4)),
    EMERALD_ORE(25, 3, 1.5, 3, new Drop(Items.get("EMERALD"), 1, 3)),
