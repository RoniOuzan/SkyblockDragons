...
public class MinerNPC extends InteractableNPC {
    ...
    private final List<PlayerSD> took;
    ...
    public MinerNPC(Location location) {
        ...
        addInteraction(p -> new ConditionInteraction(this, () -> p.hasItem(Items.get("COBBLESTONE_PICKAXE"), 1),
                ...
                new TalkWaitInteraction(this, "Give me your Cobblestone Pickaxe that I gave you earlier, I will upgrade it and then we will go to our adventure.", 1)
        ).setRepeatUntil(took::contains));
        addInteraction(p -> new SequentialGroupInteraction(this,
        ...
        // TODO: change it to bring and not mine
    }
}
