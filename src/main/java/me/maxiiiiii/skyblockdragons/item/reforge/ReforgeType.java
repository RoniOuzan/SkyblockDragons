...
public enum ReforgeType {
    ...
    WISE(new ArrayList<>(Arrays.asList(new Stats(6, 0, 1, 25), new Stats(8, 0, 1, 50), new Stats(10, 0, 1, 75), new Stats(12, 0, 2, 100), new Stats(15, 0, 2, 120), new Stats(2, 0, 3, 150))), ItemTypeGroup.ARMOR.toType(), false),
    // Accessories
