...
public class DiamondHoeTier4 extends FarmingMaterial {
    public DiamondHoeTier4() {
        super("DIAMOND_HOE_4",
        ...
        cropAdder.put(Material.BEETROOT_BLOCK, new BlockItemDrop(Items.get("BEETROOT"), 4));
    }
}
