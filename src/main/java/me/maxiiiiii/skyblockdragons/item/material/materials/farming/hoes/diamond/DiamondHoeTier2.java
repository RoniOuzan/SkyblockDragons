...
public class DiamondHoeTier2 extends FarmingMaterial {
    public DiamondHoeTier2() {
        super("DIAMOND_HOE_2",
        ...
        cropAdder.put(Material.BEETROOT_BLOCK, new BlockItemDrop(Items.get("BEETROOT"), 2));
    }
}
