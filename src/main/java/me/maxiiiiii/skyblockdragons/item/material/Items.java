...
public class Items {
    ...
    public static void registerItems() {
        ...
        items.put("GOLD_SWORD", new SwordMaterial(Material.GOLD_SWORD, ItemFamily.GOLD, "Gold Sword", Rarity.COMMON, new Stats(20, 15, 5, 0, 0,0 ,0, 0, 0, 0), ""));
        items.put("DIAMOND_SWORD", new SwordMaterial(Material.DIAMOND_SWORD, ItemFamily.DIAMOND, "Diamond Sword", Rarity.UNCOMMON, new Stats(35, 25, 5, 0, 0,0 ,0, 0, 0, 0), ""));
        items.put("OBSIDIAN_SWORD", new SwordMaterial(Material.STONE_SWORD, ItemFamily.OBSIDIAN, "Obsidian Sword", Rarity.RARE, new Stats(85, 45, 15, 2, 0,0 ,0, 0, -5, 0), ""));

        items.put("PIGMAN_DAGGER", new SwordMaterial(Material.GOLD_SWORD, ItemFamily.PIGMAN, "Pigman Dagger", Rarity.UNCOMMON, new Stats(65, 25, 10, 0, 0, 0, 0, 0, 0, 20), "", new ItemAbility(AbilityAction.RIGHT_CLICK, "Burning", "Cast vortex of " + ChatColor.RED + "flames " + ChatColor.GRAY + "towards enemies that deals " + ChatColor.RED + "ABILITY_DAMAGE " + ChatColor.GRAY + "damage.", 15, 5, 40, 0)));

        items.put("ASPECT_OF_THE_END", new SwordMaterial(Material.DIAMOND_SWORD, ItemFamily.ASPECT_OF_THE_END,"Aspect of The End", Rarity.RARE, new Stats(100, 100, 0, 0, 0, 0, 0, 0, 0, 0), "", new ItemAbility(AbilityAction.RIGHT_CLICK, "Transmission", ChatColor.GRAY + "Teleport " + ChatColor.GREEN + "8 blocks " + ChatColor.GRAY + "ahead of you and gain " + ChatColor.GREEN + "+50 " + StatType.SPEED.getIconAndText() + " NEW_LINE for " + ChatColor.GREEN + "3 seconds" + ChatColor.GRAY + ".", 50, 0)));
        items.put("ASPECT_OF_THE_VOID", new SwordMaterial(Material.DIAMOND_SPADE, ItemFamily.ASPECT_OF_THE_END, "Aspect of The Void", Rarity.EPIC, new Stats(120, 100, 0, 0, 0, 0, 0, 0, 0, 0), "", new ItemAbility(AbilityAction.RIGHT_CLICK, "Transmission", ChatColor.GRAY + "Teleport " + ChatColor.GREEN + "12 blocks " + ChatColor.GRAY + "ahead of you and gain " + ChatColor.GREEN + "+50 " + StatType.SPEED.getIconAndText() + " NEW_LINE for " + ChatColor.GREEN + "3 seconds" + ChatColor.GRAY + ".", 45, 0), new ItemAbility(AbilityAction.RIGHT_SHIFT_CLICK, "Ether Transmission", ChatColor.GRAY + "Teleport to your targeted block up to " + ChatColor.GREEN + "61 blocks " + ChatColor.GRAY + "away.", 180, 0)));
        items.put("BONZO_STAFF", new SwordMaterial(Material.BLAZE_ROD, ItemFamily.BONZO_STAFF, "Bonzo's Staff", Rarity.RARE , new Stats(160, 0, 0, 0, 0, 0, 0, 0, 0, 250), "", new ItemAbility(AbilityAction.RIGHT_CLICK, "Showtime", ChatColor.GRAY + "Shoots balloons that create a large explosion on impact", 50, 0)));
        items.put("LEAPING_SWORD", new SwordMaterial(Material.GOLD_SWORD, ItemFamily.LEAPING_SWORD, "Leaping Sword", Rarity.EPIC, new Stats(150, 100, 25, 0, 0, 0, 0, 0, 0, 0), "", new ItemAbility(AbilityAction.RIGHT_CLICK, "Leap", "Leap into the air and deal " + ChatColor.GREEN + "400 " + ChatColor.GRAY + "base Magic Damage to nearby NEW_LINE enemies upon landing on the NEW_LINE ground. Damaged enemies will NEW_LINE also be frozen for " + ChatColor.GREEN + "1 second" + ChatColor.GRAY + ".", 50, 1)));
        items.put("ATOMSPLIT_KATANA", new SwordMaterial(Material.DIAMOND_SWORD, ItemFamily.VOIDWALKER_KATANA, "Atomsplit Katana", Rarity.LEGENDARY, new Stats(240, 100, 25, 0, 0, 0, 0, 0, 0, 300), "Deal " + ChatColor.GREEN + "+200% RESET_LENGTH " + ChatColor.GRAY + "damage to Endermen.", new ItemAbility(AbilityAction.RIGHT_CLICK, "Soulcry", "Gain " + ChatColor.RED + "+400" + StatType.FEROCITY.getIconAndText() + ChatColor.GRAY + " against Endermen for " + ChatColor.GREEN + "4 seconds" + ChatColor.GRAY + ".", 200, 4)));
        items.put("SOUL_WHIP", new SwordMaterial(Material.FISHING_ROD, ItemFamily.SOUL_WHIP, "Soul Whip", Rarity.LEGENDARY, new Stats(145, 175, 0, 0, 0, 0, 0, 0, 0, 0), "", new ItemAbility(AbilityAction.RIGHT_CLICK, "Flay", "Flay your whip in an arc, dealing your melee damage to all enemeies in its path.", 0, 0)));
        items.put("FLOWER_OF_TRUTH", new SwordMaterial(Material.RED_ROSE, ItemFamily.FLOWER_OF_TRUTH, "Flower of Truth", Rarity.LEGENDARY, new Stats(100, 360, 0, 0, 0, 0, 0, 0, 0, 0), "", new ItemAbility(AbilityAction.RIGHT_CLICK, "Heat-Seeking Rose", "Shoots a rose that ricochets between enemies, damaging up to " + ChatColor.GREEN + "3 " + ChatColor.GRAY + "of your foes! Damage multiplies as more enemies are hit.", 100000, 1)));
        items.put("SHADOW_FURY", new SwordMaterial(Material.DIAMOND_SWORD, ItemFamily.SHADOW_FURY, "Shadow Fury", Rarity.LEGENDARY, new Stats(300, 125, 0, 0, 0, 0, 0, 0, 30, 0), "", new ItemAbility(AbilityAction.RIGHT_CLICK, "Shadow Fury", "Rapidly teleports you to up to " + ChatColor.AQUA + "5 " + ChatColor.GRAY + "enemies within " + ChatColor.YELLOW + "10 " + ChatColor.GRAY + "blocks, rooting each of them and allowing you to hit them.", 0, 15)));
        items.put("SPIRIT_SCEPTRE", new SwordMaterial(Material.RED_ROSE, ItemFamily.SPIRIT_SCEPTRE, "Spirit Spectre", Rarity.LEGENDARY, "2", "", new Stats(180, 0, 0, 0, 0, 0, 0, 0, 0, 300), "", new ItemAbility(AbilityAction.RIGHT_CLICK, "Guided Bat", "Shoots a guided spirit bat, following your aim and exploding for " + ChatColor.RED + "2,000 " + ChatColor.GRAY + "damage.", 250, 0)));
        items.put("ROGUE_SWORD", new SwordMaterial(Material.GOLD_SWORD, ItemFamily.ROGUE_SWORD, "Rogue Sword", Rarity.COMMON, new Stats(20, 0, 0, 0, 0, 0, 0, 0, 0, 0), "", new ItemAbility(AbilityAction.RIGHT_CLICK, "Speed Boost", "Increases your movement " + StatType.SPEED.getIconAndText() + " " + ChatColor.GRAY + "by " + ChatColor.GREEN + "+20 " + ChatColor.GRAY + "for " + ChatColor.GREEN + "30 " + ChatColor.GRAY + "seconds. Only gives " + ChatColor.GREEN + "+10 " + StatType.SPEED.getIconAndText() + " " + ChatColor.GRAY + "if already in use.", 50, 0)));
        items.put("AXE_OF_THE_SHREDDED", new SwordMaterial(Material.DIAMOND_AXE, ItemFamily.REVENANT_FALCHION, "Axe of the Shredded", Rarity.LEGENDARY, new Stats(140, 115, 0, 0, 0, 0, 0, 0, 0, 0), "Heal " + ChatColor.RED + "50" + StatType.HEALTH.getIcon() + " " + ChatColor.GRAY + "per hit." + " NEW_LINE " + "Deal " + ChatColor.GREEN + "+250% " + ChatColor.GRAY + "damage to Zombies." + " NEW_LINE " + "Receive " + ChatColor.GREEN + "25% " + ChatColor.GRAY + "less damage from Zombies when held.", new ItemAbility(AbilityAction.RIGHT_CLICK, "Throw", "Throw your axe damaging all enemies in its path dealing " + ChatColor.RED + "10% " + ChatColor.GRAY + "melee damage. Consecutive throws stack " + ChatColor.RED + "2x " + ChatColor.GRAY + "damage but cost " + ChatColor.BLUE + "2x " + ChatColor.GRAY + "mana up to 16x", 20, 0)));
        items.put("MIDAS_STAFF", new SwordMaterial(Material.GOLD_SPADE, ItemFamily.MIDAS_STAFF, "Midas Staff", Rarity.LEGENDARY, new Stats(130, 150, 0, 0, 0, 0, 0, 0, 0, 50), ChatColor.GOLD + "Ability Greed" + " NEW_LINE " + ChatColor.GRAY + "The " + ChatColor.DARK_AQUA + "ability damage bonus " + ChatColor.GRAY + "of this item is dependent on the price paid for it at the " + ChatColor.DARK_PURPLE + "Dark Action" + ChatColor.GRAY + "! The maximum bonus of this item is " + ChatColor.DARK_AQUA + "26,000 " + ChatColor.GRAY + "if the bid was " + ChatColor.GOLD + "100,000,000 Coins " + ChatColor.GRAY + "or higher!", new ItemAbility(AbilityAction.RIGHT_CLICK, "Molten Wave", "Cast a wave of molten gold in the direction you are facing! Deals up to " + ChatColor.RED + "6,000 " + ChatColor.GRAY + "damage.", 500, 1)));
        ...
        // Armors
        // Leather
        items.put("LEATHER_HELMET", new ArmorMaterial(Material.LEATHER_HELMET, ItemFamily.LEATHER, "Leather Helmet", ItemType.HELMET, Rarity.COMMON, new Stats(0, 0, 0, 0, 0, 0, 5, 0, 0, 0), "", ItemFullSet.NULL, null));
        items.put("LEATHER_CHESTPLATE", new ArmorMaterial(Material.LEATHER_CHESTPLATE, ItemFamily.LEATHER, "Leather Chestplate", ItemType.CHESTPLATE, Rarity.COMMON, new Stats(0, 0, 0, 0, 0, 0, 5, 0, 0, 0), "", ItemFullSet.NULL, null));
        items.put("LEATHER_LEGGINGS", new ArmorMaterial(Material.LEATHER_LEGGINGS, ItemFamily.LEATHER, "Leather Leggings", ItemType.LEGGINGS, Rarity.COMMON, new Stats(0, 0, 0, 0, 0, 0, 5, 0, 0, 0), "", ItemFullSet.NULL, null));
        items.put("LEATHER_BOOTS", new ArmorMaterial(Material.LEATHER_BOOTS, ItemFamily.LEATHER, "Leather Boots", ItemType.BOOTS, Rarity.COMMON, new Stats(0, 0, 0, 0, 0, 0, 5, 0, 0, 0), "", ItemFullSet.NULL, null));
        // Chain
        ...
        // Obsidian
        items.put("OBSIDIAN_HELMET", new ArmorMaterial(Material.SKULL_ITEM, ItemFamily.OBSIDIAN, "Obsidian Helmet", ItemType.HELMET, Rarity.RARE, "4871fc40-b2c7-431d-9eb8-b54cd666dca7", "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNzg0MGI4N2Q1MjI3MWQyYTc1NWRlZGM4Mjg3N2UwZWQzZGY2N2RjYzQyZWE0NzllYzE0NjE3NmIwMjc3OWE1In19fQ==", new Stats(0, 8, 12, 0, 0, 0, 95, 45, -5, 5), "", ItemFullSet.NULL));
        items.put("OBSIDIAN_CHESTPLATE", new ArmorMaterial(Material.LEATHER_CHESTPLATE, ItemFamily.OBSIDIAN, "Obsidian Chestplate", ItemType.CHESTPLATE, Rarity.RARE, new Stats(0, 8, 12, 0, 0, 0, 95, 45, -5, 5), "", ItemFullSet.NULL));
        items.put("OBSIDIAN_LEGGINGS", new ArmorMaterial(Material.LEATHER_LEGGINGS, ItemFamily.OBSIDIAN, "Obsidian Leggings", ItemType.LEGGINGS, Rarity.RARE, new Stats(0, 8, 12, 0, 0, 0, 95, 45, -5, 5), "", ItemFullSet.NULL));
        items.put("OBSIDIAN_BOOTS", new ArmorMaterial(Material.LEATHER_BOOTS, ItemFamily.OBSIDIAN, "Obsidian Boots", ItemType.BOOTS, Rarity.RARE, new Stats(0, 8, 12, 0, 0, 0, 95, 45, -5, 5), "", ItemFullSet.NULL));
        // Golden Skeleton
        ...
        // Ender
        items.put("ENDER_HELMET", new ArmorMaterial(Material.SKULL_ITEM, ItemFamily.ENDER, "Ender Helmet", ItemType.HELMET, Rarity.RARE, "7ddb45e0-6b48-4e42-943e-b0a6dcec34ee", "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZjcxNWNhMGY3NDI1NDRhZTNjYTEwNDI5NzU3OGMyZWQ3MDBlYTNhNTQ5ODA0MTM1MTJmNWU3YTBiYzA2NzI5YSJ9fX0=", new Stats(0, 12, 12, 2, 0, 0, 135, 60, 0, 10), "Increases all damage stats by " + ChatColor.GREEN + "5% " + ChatColor.GRAY + "in " + ChatColor.DARK_PURPLE + "The End" + ChatColor.GRAY + ".", ItemFullSet.NULL));
        items.put("ENDER_CHESTPLATE", new ArmorMaterial(Material.CHAINMAIL_CHESTPLATE, ItemFamily.ENDER, "Ender Chestplate", ItemType.CHESTPLATE, Rarity.RARE, "", "", new Stats(0, 12, 12, 2, 0, 0, 135, 60, 0, 10), "Increases all damage stats by " + ChatColor.GREEN + "5% " + ChatColor.GRAY + "in " + ChatColor.DARK_PURPLE + "The End" + ChatColor.GRAY + ".", ItemFullSet.NULL));
        items.put("ENDER_LEGGINGS", new ArmorMaterial(Material.CHAINMAIL_LEGGINGS, ItemFamily.ENDER, "Ender Leggings", ItemType.LEGGINGS, Rarity.RARE, "", "", new Stats(0, 12, 12, 2, 0, 0, 135, 60, 0, 10), "Increases all damage stats by " + ChatColor.GREEN + "5% " + ChatColor.GRAY + "in " + ChatColor.DARK_PURPLE + "The End" + ChatColor.GRAY + ".", ItemFullSet.NULL));
        items.put("ENDER_BOOTS", new ArmorMaterial(Material.CHAINMAIL_BOOTS, ItemFamily.ENDER, "Ender Boots", ItemType.BOOTS, Rarity.RARE, "", "", new Stats(0, 12, 12, 2, 0, 0, 135, 60, 0, 10), "Increases all damage stats by " + ChatColor.GREEN + "5% " + ChatColor.GRAY + "in " + ChatColor.DARK_PURPLE + "The End" + ChatColor.GRAY + ".", ItemFullSet.NULL));
        // Ender Guard
        items.put("ENDER_GUARD_HELMET", new ArmorMaterial(Material.SKULL_ITEM, ItemFamily.ENDER, "Ender Guard Helmet", ItemType.HELMET, Rarity.EPIC, "0dc3174c-0fac-4cb1-8c5f-3dba5c1d335b", "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZmQ4YjZmODc4OTAxNWVhNjdiMWQ3ZmE1N2E1OWQ3YTRhZDJhZTc0Y2U3ZDk5ZTY1ZmZhZDExNDg5ZTdkYzY1In19fQ==", new Stats(0, 12, 12, 2, 0, 0, 135, 60, 0, 10), "Increases all damage stats by " + ChatColor.GREEN + "10% " + ChatColor.GRAY + "in " + ChatColor.DARK_PURPLE + "The End" + ChatColor.GRAY + ".", ItemFullSet.NULL));
        items.put("ENDER_GUARD_CHESTPLATE", new ArmorMaterial(Material.CHAINMAIL_CHESTPLATE, ItemFamily.ENDER, "Ender Guard Chestplate", ItemType.CHESTPLATE, Rarity.EPIC, "", "", new Stats(0, 12, 12, 2, 0, 0, 135, 60, 0, 10), "Increases all damage stats by " + ChatColor.GREEN + "10% " + ChatColor.GRAY + "in " + ChatColor.DARK_PURPLE + "The End" + ChatColor.GRAY + ".", ItemFullSet.NULL));
        ...
        items.put("ENDER_GUARD_BOOTS", new ArmorMaterial(Material.CHAINMAIL_BOOTS, ItemFamily.ENDER, "Ender Guard Boots", ItemType.BOOTS, Rarity.EPIC, "", "", new Stats(0, 12, 12, 2, 0, 0, 135, 60, 0, 10), "Increases all damage stats by " + ChatColor.GREEN + "10% " + ChatColor.GRAY + "in " + ChatColor.DARK_PURPLE + "The End" + ChatColor.GRAY + ".", ItemFullSet.NULL));
        // Necron
        ...
        // Superior
        items.put("SUPERIOR_DRAGON_HELMET", new ArmorMaterial(Material.SKULL_ITEM, ItemFamily.SUPERIOR_DRAGON_ARMOR, "Superior Dragon Helmet", ItemType.HELMET, Rarity.LEGENDARY, "7fd17d6f-9e42-478c-8cce-68aec1d52eec", "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNzU1OGVmYmU2Njk3NjA5OWNmZDYyNzYwZDllMDUxNzBkMmJiOGY1MWU2ODgyOWFiOGEwNTFjNDhjYmM0MTVjYiJ9fX0=", new Stats(0, 10, 10, 2, 0, 0, 90, 130, 3, 25), "", ItemFullSet.SUPERIOR_DRAGON));
        items.put("SUPERIOR_DRAGON_CHESTPLATE", new ArmorMaterial(Material.LEATHER_CHESTPLATE, ItemFamily.SUPERIOR_DRAGON_ARMOR, "Superior Dragon Helmet", ItemType.CHESTPLATE, Rarity.LEGENDARY, new Stats(0, 10, 10, 2, 0, 0, 150, 190, 3, 25), "", ItemFullSet.SUPERIOR_DRAGON, Color.fromRGB(242,223,17)));
        items.put("SUPERIOR_DRAGON_LEGGINGS", new ArmorMaterial(Material.LEATHER_LEGGINGS, ItemFamily.SUPERIOR_DRAGON_ARMOR, "Superior Dragon Helmet", ItemType.LEGGINGS, Rarity.LEGENDARY, new Stats(0, 10, 10, 2, 0, 0, 130, 170, 3, 25), "", ItemFullSet.SUPERIOR_DRAGON, Color.fromRGB(242,223,17)));
        items.put("SUPERIOR_DRAGON_BOOTS", new ArmorMaterial(Material.LEATHER_BOOTS, ItemFamily.SUPERIOR_DRAGON_ARMOR, "Superior Dragon Helmet", ItemType.BOOTS, Rarity.LEGENDARY, new Stats(0, 10, 10, 2, 0, 0, 80, 110, 3, 25), "", ItemFullSet.SUPERIOR_DRAGON, Color.fromRGB(242,93,24)));
