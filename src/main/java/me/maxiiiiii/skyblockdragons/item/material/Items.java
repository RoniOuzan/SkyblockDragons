...
public class Items {
    ...
    public static void registerItems() {
        ...
        items.put("ADMIN_PRO_SWORD", new SwordMaterial(Material.IRON_SWORD, ItemFamily.ADMIN, "Admin PRO Sword", Rarity.SPECIAL, new Stats(100000, 100000, 100000, 100000, 100000,0 ,0, 100000, 0, 1000), ""));
        ...
        items.put("ENDER_LEGGINGS", new ArmorMaterial(Material.CHAINMAIL_LEGGINGS, ItemFamily.ENDER, "Ender Leggings", ItemType.LEGGINGS, Rarity.RARE, "", "", new Stats(0, 12, 12, 2, 0, 0, 135, 60, 0, 10), "Increases all damage stats by " + ChatColor.GREEN + "5% " + ChatColor.GRAY + "in " + ChatColor.DARK_PURPLE + "The End" + ChatColor.GRAY + ".", ItemFullSet.NULL, new SkillRequirement(SkillType.COMBAT, 12)));
        items.put("ENDER_BOOTS", new ArmorMaterial(Material.CHAINMAIL_BOOTS, ItemFamily.ENDER, "Ender Boots", ItemType.BOOTS, Rarity.RARE, "", "", new Stats(0, 12, 12, 2, 0, 0, 135, 60, 0, 10), "Increases all damage stats by " + ChatColor.GREEN + "5% " + ChatColor.GRAY + "in " + ChatColor.DARK_PURPLE + "The End" + ChatColor.GRAY + ".", ItemFullSet.NULL, new SkillRequirement(SkillType.COMBAT, 12)));
        // Ender Guard
        items.put("ENDER_GUARD_HELMET", new ArmorMaterial(Material.SKULL_ITEM, ItemFamily.ENDER, "Ender Guard Helmet", ItemType.HELMET, Rarity.EPIC, "0dc3174c-0fac-4cb1-8c5f-3dba5c1d335b", "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZmQ4YjZmODc4OTAxNWVhNjdiMWQ3ZmE1N2E1OWQ3YTRhZDJhZTc0Y2U3ZDk5ZTY1ZmZhZDExNDg5ZTdkYzY1In19fQ==", new Stats(0, 12, 12, 2, 0, 0, 135, 60, 0, 10), "Increases all damage stats by " + ChatColor.GREEN + "10% " + ChatColor.GRAY + "in " + ChatColor.DARK_PURPLE + "The End" + ChatColor.GRAY + ".", ItemFullSet.NULL, new SkillRequirement(SkillType.COMBAT, 15)));
        ...
        items.put("SUPERIOR_DRAGON_LEGGINGS", new ArmorMaterial(Material.LEATHER_LEGGINGS, ItemFamily.SUPERIOR_DRAGON, "Superior Dragon Leggings", ItemType.LEGGINGS, Rarity.LEGENDARY, new Stats(0, 10, 10, 2, 0, 0, 130, 170, 3, 25), "", ItemFullSet.SUPERIOR_DRAGON, Color.fromRGB(242,223,17), new SkillRequirement(SkillType.COMBAT, 21)));
        items.put("SUPERIOR_DRAGON_BOOTS", new ArmorMaterial(Material.LEATHER_BOOTS, ItemFamily.SUPERIOR_DRAGON, "Superior Dragon Boots", ItemType.BOOTS, Rarity.LEGENDARY, new Stats(0, 10, 10, 2, 0, 0, 80, 110, 3, 25), "", ItemFullSet.SUPERIOR_DRAGON, Color.fromRGB(242,93,24), new SkillRequirement(SkillType.COMBAT, 21)));
        // Strong
    ...
    // Deeper Mines
        ...
        items.put("CHLOROPHYTE_LEGGINGS", new ArmorMaterial(Material.LEATHER_CHESTPLATE, ItemFamily.CHLOROPHYTE, "Chlorophyte Leggings", ItemType.LEGGINGS, Rarity.UNCOMMON, new Stats(60, 40, 0, 20, 120, 30, 0), "", ItemFullSet.CHLOROPHYTE, Color.fromRGB(23, 228, 0)));
