    ...
    public static class Transmission extends ItemAbility implements ItemAbilityManaCost {
        ...
        public Transmission(double blocks) {
            super(AbilityAction.RIGHT_CLICK,
                    "Transmission",
                    ChatColor.GRAY + "Teleport " + ChatColor.GREEN + blocks + " blocks " + ChatColor.GRAY + "ahead of you and gain " + ChatColor.GREEN + "+50 " + StatTypes.SPEED + "for " + ChatColor.GREEN + "3 seconds" + ChatColor.GRAY + "."
            );
            this.blocks = blocks;
        }
