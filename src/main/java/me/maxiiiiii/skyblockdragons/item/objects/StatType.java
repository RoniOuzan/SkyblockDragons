...
public enum StatType {
    ...
    FARMING_FORTUNE(Material.GOLD_HOE, ChatColor.GOLD + "☘", ChatColor.GOLD + "☘ Farming Fortune", false),
    FORAGING_FORTUNE(Material.GOLD_AXE, ChatColor.GOLD + "☘", ChatColor.GOLD + "☘ Foraging Fortune", false),
