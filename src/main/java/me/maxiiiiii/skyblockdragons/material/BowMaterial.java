...
public class BowMaterial extends WeaponMaterial {
    ...
    BowMaterial(Material material, ItemFamily family, String name, Rarity rarity, String id, String nbt, ArrayList<Integer> stats, String description, ArrayList<ItemAbility> abilities) {
        super(material, family, name, ItemType.BOW, rarity, id, nbt, stats, description, abilities);
    }

    BowMaterial(Material material, ItemFamily family, String name, Rarity rarity, ArrayList<Integer> stats, String description, ArrayList<ItemAbility> abilities) {
        this(material, family, name, rarity, "", "", stats, description, abilities);
    }

    BowMaterial(Material material, ItemFamily family, String name, Rarity rarity, ArrayList<Integer> stats, String description, ItemAbility ability) {
