...
public class Items {
    ...
    public static void registerItems() {
        ...
        items.put("GOLD_SWORD", new SwordMaterial(Material.GOLD_SWORD, ItemFamily.GOLD, "Gold Sword", Rarity.COMMON, new Stats(15, 5, 0, 0, 0,0 ,0, 0, 0, 0), ""));
        items.put("DIAMOND_SWORD", new SwordMaterial(Material.DIAMOND_SWORD, ItemFamily.DIAMOND, "Diamond Sword", Rarity.UNCOMMON, new Stats(15, 10, 0, 0, 0,0 ,0, 0, 0, 0), ""));
        items.put("OBSIDIAN_SWORD", new SwordMaterial(Material.STONE_SWORD, ItemFamily.OBSIDIAN, "Obsidian Sword", Rarity.RARE, new Stats(45, 25, 5, 0, 0,0 ,0, 0, 0, 0), ""));

        items.put("PIGMAN_DAGGER", new SwordMaterial(Material.GOLD_SWORD, ItemFamily.PIGMAN, "Pigman Dagger", Rarity.UNCOMMON, new Stats(25, 20, 5, 0, 0, 0, 0, 0, 0, 20), "", new ItemAbility(AbilityAction.RIGHT_CLICK, "Burning", "Cast vortex of " + ChatColor.RED + "flames " + ChatColor.GRAY + "towards enemies that deals " + ChatColor.RED + "ABILITY_DAMAGE " + ChatColor.GRAY + "damage.", 15, 5, 40, 0)));
        ...
        // Obsidian
        items.put("OBSIDIAN_HELMET", new ArmorMaterial(Material.OBSIDIAN, ItemFamily.OBSIDIAN, "Obsidian Helmet", ItemType.HELMET, Rarity.RARE, new Stats(0, 8, 12, 0, 0, 0, 95, 45, -5, 5), "", ItemFullSet.NULL));
