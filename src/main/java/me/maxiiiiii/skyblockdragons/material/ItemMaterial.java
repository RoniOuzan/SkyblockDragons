...
public class ItemMaterial {
    ...
    // Swords
    public static SwordMaterial ASPECT_OF_THE_END = null;
    public static SwordMaterial ASPECT_OF_THE_VOID = null;
    public static SwordMaterial BONZO_STAFF = null;
    public static SwordMaterial LEAPING_SWORD = null;
    public static SwordMaterial ATOMSPLIT_KATANA = null;
    public static SwordMaterial SOUL_WHIP = null;
    public static SwordMaterial FLOWER_OF_TRUTH = null;
    public static SwordMaterial SHADOW_FURY = null;
    public static SwordMaterial SPIRIT_SCEPTRE = null;
    public static SwordMaterial ROGUE_SWORD = null;
    public static SwordMaterial AXE_OF_THE_SHREDDED = null;
    public static SwordMaterial MIDAS_STAFF = null;

    public static NecronBladeMaterial VALKYRIE = null;

    // Bows
    public static BowMaterial TERMINATOR = null;
    public static BowMaterial BONEMERANG = null;

    // Armors
    // Necron
    public static ArmorMaterial NECRON_HELMET = null;
    public static ArmorMaterial NECRON_CHESTPLATE = null;
    public static ArmorMaterial NECRON_LEGGINGS = null;
    public static ArmorMaterial NECRON_BOOTS = null;
    // Storm
    public static ArmorMaterial STORM_HELMET = null;
    public static ArmorMaterial STORM_CHESTPLATE = null;
    public static ArmorMaterial STORM_LEGGINGS = null;
    public static ArmorMaterial STORM_BOOTS = null;
    // Superior
    public static ArmorMaterial SUPERIOR_DRAGON_HELMET = null;
    public static ArmorMaterial SUPERIOR_DRAGON_CHESTPLATE = null;
    public static ArmorMaterial SUPERIOR_DRAGON_LEGGINGS = null;
    public static ArmorMaterial SUPERIOR_DRAGON_BOOTS = null;

    // Axes
    public static ToolMaterial TREE_CAPITATOR = null;

    // Pickaxes
    public static ToolMaterial WORLD_EATER = null;

    // Reforges
    public static ReforgeMaterial PRECURSOR_GEAR = null;
    public static ReforgeMaterial WITHER_BLOOD = null;
    public static ReforgeMaterial NECROMANCER_BROOCH = null;

    // Skins
    public static SkinMaterial NECRON_HELMET_SKIN = null;
    public static SkinMaterial STORM_HELMET_SKIN = null;
    public static SkinMaterial SUPERIOR_DRAGON_HELMET_SKIN = null;

    // Accessories
    public static AccessoryMaterial NETHER_ARTIFACT = null;

    // Wands
    public static ToolMaterial GYROKINETIC_WAND = null;
    public static ToolMaterial TORNADO_WAND = null;
    public static ToolMaterial TWISTER_WAND = null;
    public static ToolMaterial HURRICANE_WAND = null;
    public static ToolMaterial PARABOLA_WAND = null;
    public static ToolMaterial BUILDERS_WAND = null;
    public static ToolMaterial ICE_SPRAY_WAND = null;
    public static ToolMaterial ERRORMERANG_WAND = null;

    // Scrolls
    public static NecronBladeMaterial.NecronBladeScroll IMPLOSION = null;
    public static NecronBladeMaterial.NecronBladeScroll WITHER_SHIELD = null;
    public static NecronBladeMaterial.NecronBladeScroll SHADOW_WARP = null;
    public static NecronBladeMaterial.NecronBladeScroll WITHER_IMPACT = null;

    // Power Orbs
    public static PowerOrbMaterial RADIANT_POWER_ORB = null;
    public static PowerOrbMaterial MANA_FLUX_POWER_ORB = null;
    public static PowerOrbMaterial OVERFLUX_POWER_ORB = null;
    public static PowerOrbMaterial PLASMA_POWER_ORB = null;

    // Items
    public static ToolMaterial GRAPPLING_HOOK = null;
    public static ToolMaterial TROLL_EYE = null;
    public static ToolMaterial RECOMBABULATOR = null;
    public static ToolMaterial ELECTRO_MAGNET = null;

    // Normal Items
    public static NormalMaterial ENCHANTED_EYE_OF_ENDER = null;
    public static NormalMaterial ENCHANTED_DIAMOND = null;
    public static NormalMaterial HOT_POTATO_BOOK = null;
    public static NormalMaterial FUMING_POTATO_BOOK = null;

    // Other Items
    public static NormalMaterial NULL_OVOID = null;

    public static BookMaterial ENCHANTED_BOOK = new BookMaterial(Material.ENCHANTED_BOOK, ItemFamily.BOOK, "Enchanted Book", ItemType.BOOK, Rarity.COMMON, "", "");

//    public static int[][] petNeedXps = {
//            {100, 110, 120, 130, 140, 150, 160, 175, 190, 210, 230, 250, 275, 300, 330, 360, 400, 440, 490, 540, 600, 660, 730, 800, 880, 960, 1050, 1150, 1260, 1380, 1510, 1650, 1800, 1960, 2130, 2310, 2500, 2700, 2920, 3160, 3420, 3700, 4000, 4350, 4750, 5200, 5700, 6300, 7000, 7800, 8700, 9700},
//            {},
//            {},
//            {},
//            {},
...
//    };
    ...
    public static void registerItems() {
        ...
        // Swords
        ASPECT_OF_THE_END = (SwordMaterial) Items.get("ASPECT_OF_THE_END");
        ASPECT_OF_THE_VOID = (SwordMaterial) Items.get("ASPECT_OF_THE_VOID");
        BONZO_STAFF = (SwordMaterial) Items.get("BONZO_STAFF");
        LEAPING_SWORD = (SwordMaterial) Items.get("LEAPING_SWORD");
        ATOMSPLIT_KATANA = (SwordMaterial) Items.get("ATOMSPLIT_KATANA");
        SOUL_WHIP = (SwordMaterial) Items.get("SOUL_WHIP");
        FLOWER_OF_TRUTH = (SwordMaterial) Items.get("FLOWER_OF_TRUTH");
        SHADOW_FURY = (SwordMaterial) Items.get("SHADOW_FURY");
        SPIRIT_SCEPTRE = (SwordMaterial) Items.get("SPIRIT_SCEPTRE");
        ROGUE_SWORD = (SwordMaterial) Items.get("ROGUE_SWORD");
        AXE_OF_THE_SHREDDED = (SwordMaterial) Items.get("AXE_OF_THE_SHREDDED");

        VALKYRIE = (NecronBladeMaterial) Items.get("VALKYRIE");

        // Bows
        TERMINATOR = (BowMaterial) Items.get("TERMINATOR");
        BONEMERANG = (BowMaterial) Items.get("BONEMERANG");

        // Armors
        // Necron
        NECRON_HELMET = (ArmorMaterial) Items.get("NECRON_HELMET");
        NECRON_CHESTPLATE = (ArmorMaterial) Items.get("NECRON_CHESTPLATE");
        NECRON_LEGGINGS = (ArmorMaterial) Items.get("NECRON_LEGGINGS");
        NECRON_BOOTS = (ArmorMaterial) Items.get("NECRON_BOOTS");
        // Storm
        STORM_HELMET = (ArmorMaterial) Items.get("STORM_HELMET");
        STORM_CHESTPLATE = (ArmorMaterial) Items.get("STORM_CHESTPLATE");
        STORM_LEGGINGS = (ArmorMaterial) Items.get("STORM_LEGGINGS");
        STORM_BOOTS = (ArmorMaterial) Items.get("STORM_BOOTS");
        // Superior
        SUPERIOR_DRAGON_HELMET = (ArmorMaterial) Items.get("SUPERIOR_DRAGON_HELMET");
        SUPERIOR_DRAGON_CHESTPLATE = (ArmorMaterial) Items.get("SUPERIOR_DRAGON_CHESTPLATE");
        SUPERIOR_DRAGON_LEGGINGS = (ArmorMaterial) Items.get("SUPERIOR_DRAGON_LEGGINGS");
        SUPERIOR_DRAGON_BOOTS = (ArmorMaterial) Items.get("SUPERIOR_DRAGON_BOOTS");

        // Axes
        TREE_CAPITATOR = (ToolMaterial) Items.get("TREE_CAPITATOR");

        // Pickaxes
        WORLD_EATER = (ToolMaterial) Items.get("WORLD_EATER");

        // Reforges
        PRECURSOR_GEAR = (ReforgeMaterial) Items.get("PRECURSOR_GEAR");
        WITHER_BLOOD = (ReforgeMaterial) Items.get("WITHER_BLOOD");
        NECROMANCER_BROOCH = (ReforgeMaterial) Items.get("NECROMANCER_BROOCH");

        // Skins
        NECRON_HELMET_SKIN = (SkinMaterial) Items.get("NECRON_HELMET_SKIN");
        STORM_HELMET_SKIN = (SkinMaterial) Items.get("STORM_HELMET_SKIN");
        SUPERIOR_DRAGON_HELMET_SKIN = (SkinMaterial) Items.get("SUPERIOR_DRAGON_HELMET_SKIN");

        // Accessories
        NETHER_ARTIFACT = (AccessoryMaterial) Items.get("NETHER_ARTIFACT");

        // Wands
        GYROKINETIC_WAND = (ToolMaterial) Items.get("GYROKINETIC_WAND");
        TORNADO_WAND = (ToolMaterial) Items.get("TORNADO_WAND");
        TWISTER_WAND = (ToolMaterial) Items.get("TWISTER_WAND");
        HURRICANE_WAND = (ToolMaterial) Items.get("HURRICANE_WAND");
        PARABOLA_WAND = (ToolMaterial) Items.get("PARABOLA_WAND");
        BUILDERS_WAND = (ToolMaterial) Items.get("BUILDERS_WAND");
        ICE_SPRAY_WAND = (ToolMaterial) Items.get("ICE_SPRAY_WAND");
        ERRORMERANG_WAND = (ToolMaterial) Items.get("ERRORMERANG_WAND");

        // Scrolls
        IMPLOSION = (NecronBladeMaterial.NecronBladeScroll) Items.get("IMPLOSION");
        WITHER_SHIELD = (NecronBladeMaterial.NecronBladeScroll) Items.get("WITHER_SHIELD");
        SHADOW_WARP = (NecronBladeMaterial.NecronBladeScroll) Items.get("SHADOW_WARP");
        WITHER_IMPACT = (NecronBladeMaterial.NecronBladeScroll) Items.get("WITHER_IMPACT");

        // Items
        GRAPPLING_HOOK = (ToolMaterial) Items.get("GRAPPLING_HOOK");
        TROLL_EYE = (ToolMaterial) Items.get("TROLL_EYE");
        RECOMBABULATOR = (ToolMaterial) Items.get("RECOMBABULATOR");
        ELECTRO_MAGNET = (ToolMaterial) Items.get("ELECTRO_MAGNET");

        // Normal Items
        ENCHANTED_EYE_OF_ENDER = (NormalMaterial) Items.get("ENCHANTED_EYE_OF_ENDER");
        ENCHANTED_DIAMOND = (NormalMaterial) Items.get("ENCHANTED_DIAMOND");

        // Other Items
        NULL_OVOID = (NormalMaterial) Items.get("NULL_OVOID");
//
