                ...
                if (Functions.isSkillName(args[0])) {
                    ...
                    if (args[1].equalsIgnoreCase("give")) {
                        try {
                            ...
                            playerData.getSkill().get(args[0]).giveXp(amount, player);
                        ...
                        try {
                            double amount = Double.parseDouble(args[2]);
                            playerData.getSkill().get(args[0]).setXp(amount, player);
                        ...
                        try {
                            ...
                            playerData.getSkill().get(args[0]).setLevel(level, player);
