...
public class TextMessage {
	...
	public TextBuilder append(String text) {
		return new TextBuilder(this, esc(text));
	}
	...
	public static class TextBuilder {
		 ...
		 */
		private TextBuilder(TextMessage jsonMessage, String text) {
			message = jsonMessage;
		 ...
		 */
		public TextBuilder setHoverAsTooltip(String... lore) {
		 ...
		 * @return the json string builder to which you are applying settings.
		 */
		public TextBuilder setClickAsURL(String link) {
		 ...
		 * @return the json string builder to which you are applying settings;
		 */
		public TextBuilder setClickAsSuggestCmd(String cmd) {
